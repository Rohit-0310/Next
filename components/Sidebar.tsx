  ...
  return (
    <>
      ...
      <h3 className="my-4 text-3xl font-medium tracking-wider font-kaushan">
        <span className="text-green ">Rohit</span> Kumar
      </h3>
      ...
      >
        <div className="flex items-center justify-center">
          <GoLocation className="mr-2" /> <span>Patna,Bihar,India </span>
        </div>
        <p className="my-2 "> rohit9909mr@gmail.com </p>
        <p className="my-2"> 8804713288 / 8340419841 </p>
      </div>
      ...
      <button
        ...
        onClick={() => window.open("mailto:rohit9909mr@gmail.com")}
      >
        Email me
      </button>
      <button
